// Passive observer of one master interface. Never drives.
// AW, W beats and B are collected separately and joined, because the channels are
// independent: W beats may arrive before their AW and B may return long after WLAST.
// Reads are tracked per ID, since different-ID bursts may interleave.
